    ...
    return new Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          icon: Icon(FeatherIcons.chevronLeft, color: Color(0xff2c4057), size: 14)),
        elevation: 1,
  ...
  body: Container(
      height: MediaQuery.of(context).size.height,
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
        Text('Help', style: style.copyWith(fontWeight: FontWeight.bold, color: Color(0xff3b3b3b), fontSize: 16)),
        Text('Get in touch', style: style.copyWith(fontSize: 12, color: Color(0xff3b3b3b))),
        ],),
        ),
        Container(
        ...
        Container(
          ...
          Container(
              ...
              Text('LogoName.id@gmail.com', style: style.copyWith(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xff010101), height: 2)),
              Text('LogoName Indonesia', style: style.copyWith(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xff010101), height: 2)),
              Text('LogoName.id', style: style.copyWith(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xff010101), height: 2)),
