...
class AboutUs extends StatefulWidget {
  const AboutUs({ Key key, String title }) : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      appBar: AppBar(
        ...
        elevation: 10,
        backgroundColor: Colors.transparent,
        title: Text('Abous Us', style: style3.copyWith(color: Color(0xffffffff), 
    ...
    body: Column(children: <Widget>[
          ...
          child: Stack(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Image.asset('assets/vector-7.png', height: 90),
              ),
              Container(
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              Text('About Us', 
              style: style2.copyWith(fontSize: 30, color: Colors.white, fontWeight: FontWeight.bold)),
              Text('Dreamjob adalah tempat untuk mewujudkan mimpi kalian semua dimulai dari bekerja. Pekerjaan impian anda bisa saja ada disini. Bisa juga kerjaan biasa yang akan membawa kalian melangkah lebih jauh untuk menggapai mimpi.',
              textAlign: TextAlign.center,
              style: style.copyWith(fontSize: 12, color: Colors.white)),
              Text('Logo astronot melambangkan cita-cita yang terucapkan oleh  mayoritas individu semasa kecil. Tidak ada jalan pintas untuk menjadi astronot selain belajar dan kerja keras. Dua simbol bintang dengan ukuran kecil dan besar di logo melambangkan simbol pencapaian dan reward yang melalui progress dari kecil menjadi besar.',
              textAlign: TextAlign.center,
              style: style.copyWith(fontSize: 12, color: Colors.white)),
              Column(
                  children: [
