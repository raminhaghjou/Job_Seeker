...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: PaymentMethod(title: 'Flutter Slidable Demo'),
    );
  }
}
...
class PaymentMethod extends StatefulWidget {
  const PaymentMethod({ Key key, String title }) : super(key: key);
  @override
...
class _PaymentMethodState extends State<PaymentMethod> with SingleTickerProviderStateMixin {
  ...
  body: Container(
    ...
    child: Column(
      ...
      children: <Widget>[     
         ListTile(
          leading: Text('Telkomsel', style: style.copyWith(fontSize: 17, color: Color(0xff3b3b3b))),
        ...
        Text('Payment Method', style: style.copyWith(fontWeight: FontWeight.bold, color: Color(0xff3b3b3b))),
        Text('Choose your payments', style: style.copyWith(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xff3b3b3b), height: 2)),
        ListTile(
          leading: Text('Add Card', style: style.copyWith(fontSize: 17, color: Color(0xff3b3b3b), height: 2)),
          ...
          onTap: () { showDialog(
              ...
              content: Form(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text('Add Card', style: style.copyWith(fontSize: 14, fontWeight: FontWeight.bold)),
                          Text('Card Number', style: style.copyWith(fontSize: 11, fontWeight: FontWeight.bold, height: 2)),
                          Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                           Text('Exp Dates', style: style.copyWith(fontSize: 11, fontWeight: FontWeight.bold, height: 2)), 
                           Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                           Text('Security Code', style: style.copyWith(fontSize: 11, fontWeight: FontWeight.bold, height: 2)), 
                           Container(
                             margin: EdgeInsets.only(right: 30, top: 5, bottom: 10),                        
                           child: TextField(       
                             style: style.copyWith(fontSize: 16, color: Color(0xff8997a7)),         
        ...
        ListTile(
          leading: Text('Visa **** **** **** 5967', style: style.copyWith(fontSize: 17, color: Color(0xff3b3b3b), height: 2)),
        ...
        ListTile(
          leading: Text('Master **** **** **** 3461', style: style.copyWith(fontSize: 17, color: Color(0xff3b3b3b), height: 2)),
        ...
        ListTile(
          leading: Text('Add GoPay', style: style.copyWith(fontSize: 17, color: Color(0xff3b3b3b), height: 2)),
        ...
        ListTile(
          leading: Text('Add OVO', style: style.copyWith(fontSize: 17, color: Color(0xff3b3b3b), height: 2)),
          trailing: CircleAvatar(
            backgroundColor: Colors.black, 
            radius: 11,
            child: Image.asset('assets/icon16.png', scale: 1.6,)
          ),
        ),
         Container(
              padding: EdgeInsets.only(left: 16, right: 20),
