...
class _OrderItemState extends State<ApplyItem> {
  var _expanded = false;
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      height: _expanded ? min(widget.apply.jobs.length * 20.0 + 110, 200) : 95,
      child: Card(
        ...
        child: Column(
          children: <Widget>[
            ...
            AnimatedContainer(
              ...
              height: _expanded
                  ? min(widget.apply.jobs.length * 20.0 + 10, 100)
                  : 0,
              child: ListView(
                children: widget.apply.jobs
                    .map(
                      (prod) => Row(
