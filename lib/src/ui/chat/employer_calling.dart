...
class EmployerCalling extends StatefulWidget {
  const EmployerCalling({Key key, String title}) : super(key: key);
  @override
  _EmployerCallingState createState() => _EmployerCallingState();
}

class _EmployerCallingState extends State<EmployerCalling> with SingleTickerProviderStateMixin {
  TextStyle style =
      ...
      appBar: AppBar(
        actions: <Widget>[
          ...
          RaisedButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => OnCallingEMployer()));
            },
          ),
        ],
      ),
