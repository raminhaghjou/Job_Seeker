                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LoginSignUpSeeker()),
                      );
                    },
                    child: Text("Look for Jobs",
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => LoginSignUpEmployer()));
                    },
                    child: Text("Look for Employees",
                        textAlign: TextAlign.center,
                        style: TextStyle(color: Colors.white, fontSize: 13)),
                  ),
                  SizedBox(height: 20),
                  Column(
                    children: <Widget>[
                      ...
                      Text("www.dreamjob.co.id",
                          textAlign: TextAlign.center,
                          style:
                              TextStyle(color: Colors.cyan[400], fontSize: 10)),
                    ],
                  ),
                ],
              ),
